...
echo "=========================================="
echo " READY"
echo "   • Default debug target: trs80sim (F5) — light, no machine needed."
echo "   • Cycle-true rev-z: run task 'TRS-80: Start Machine' first (uses 1 core!)."
echo "   • Assemble: Terminal → zmac -j space_invaders.asm   (or the Assemble task)."
echo "   • Debug:    press F5 → 'TRS-80 sim (fast, with symbols)'."
echo ""
